...
const copy = {
  ...
  lead: { 'zh-CN': '码位3 是开发者、AI 工程师、运维人员与技术爱好者的社区，也是 GPTWork、chat2api、QNBot、FDEX、Aipany 等软件与服务的统一入口。', en: 'MV3 is a community for developers, AI engineers, operators and technology enthusiasts — and the shared home of GPTWork, chat2api, QNBot, FDEX and Aipany.', ja: 'MV3 は開発者、AI エンジニア、運用担当者、技術愛好家のためのコミュニティであり、GPTWork、chat2api、QNBot、FDEX、Aipany の共通ホームです。' },
};
...
export default function HomePage() {
  ...
  const features = [
    ['IDENTITY','One MV3 Account',cn?'统一账户将逐步连接码位3社区与各产品，同时保留产品级授权、设备、权益和数据边界。':ja?'共通アカウントで MV3 コミュニティと各製品を段階的につなぎ、権限・端末・権利・データ境界は製品ごとに保持します。':'Shared identity will connect the MV3 community and products while preserving product-level authorization, devices, entitlements and data boundaries.','/account',cn?'查看统一账户路线 →':ja?'共通アカウントの計画 →':'Shared identity roadmap →'],
    ['LABS','MV3 Labs',cn?'把还没成为正式产品的协议、Agent、AI 与工程实验放在一个可公开讨论的位置。':ja?'正式製品になる前のプロトコル、Agent、AI、エンジニアリング実験を公開して議論します。':'A public place for protocols, agents, AI and engineering experiments before they become products.','/labs',cn?'进入实验室 →':ja?'ラボへ →':'Enter Labs →'],
